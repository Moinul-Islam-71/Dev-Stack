...
export default function Navbar() {
    return (
        <nav className="flex justify-between items-center px-3 md:px-12 py-4 border-b-[0.1px] border-slate-200">

            <HamburgerButton />

            <img src={logo} alt="logo" />

            <ul className="hidden md:flex gap-5 justify-center items-center font-semibold text-slate-900 hover:cursor-pointer">
